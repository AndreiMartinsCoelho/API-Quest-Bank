...
exports.get = async (headers) => {
    try {
        ...
        return { status: "error", msg: "Ocorreu um erro ao obter os topicos. Por favor, tente novamente mais tarde." };
    }
}
...
exports.listar = async (body) => {
    ...
    if (result.auth) {
        return { status: "success", msg: "Topicos listados com sucesso!", topicos: result.topicos };
    } else {
